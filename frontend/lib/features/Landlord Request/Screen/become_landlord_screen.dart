...
class _BecomeLandlordScreenState extends State<BecomeLandlordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon:
          const Icon(Icons.arrow_back_ios_new, color: Color(0xFF1A1A2E)),
          onPressed: () => Navigator.pushReplacementNamed(context, '/bottomNavigator'),
        ),
      ),
  ...
  Widget _buildUpload() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Upload Citizenship Document',
            style: TextStyle(
                fontWeight: FontWeight.w700,
                fontSize: 15,
                color: Color(0xFF1A1A2E))),
        const SizedBox(height: 6),
        const Text('Please upload a clear photo of your citizenship certificate.',
          ...
          child: AnimatedContainer(
            ...
            child: _citizenshipImage != null
              ...
              children: [
                ...
                const Text('Tap to upload citizenship',
                    style: TextStyle(
